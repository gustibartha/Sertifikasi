...
/**
 * 1. KONFIGURASI TOTAL (HARDCODED)
 * Kita tulis kuncinya langsung di sini. 
 * Tidak pakai process.env lagi agar tidak error meski env di Vercel kosong.
 */
...
// Membuat client dengan header paksa
            ...
            <div className="card shadow-sm border-0 p-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-primary w-100 fw-bold" disabled={loading}>
                  {loading ? "Menghubungkan..." : "SIMPAN DATA"}
                </button>
              </form>
            </div>
          </div>
            ...
            <div className="card shadow-sm border-0 p-4">
              ...
              <div className="table-responsive">
                <table className="table table-hover border">
                  ...
                  <tbody>
                    {data.length === 0 ? (
                      <tr><td colSpan="4" className="text-center py-3 text-muted">Memuat data atau database kosong...</td></tr>
                    ) : (
                      data.map((item) => (
                        <tr key={item.id}>
